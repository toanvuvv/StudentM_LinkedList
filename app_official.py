...
from models.course import Course, CourseManager
...
all_course_infor = CourseManager()
all_course_infor.load_courses("data/courses.json")
...
def calculate_gpa(completed_courses, all_course_info):
    ...
    for completed_course in completed_courses:
        ...
        course_credit = all_course_info.get_course_credit(course_id)
...
#NOTE: can viet lai chi tiet hon
...
def show_student_list(student_manager):
    ...
    for student in students:
        ...
        gpa = calculate_gpa(student.completed_courses,all_course_infor)  # Assuming completed_courses is a list of dictionaries
...
def find_and_show_detailed_information(student_manager):
                ...
                if user.role == "administrator":
                    while True:
                        ...
                        if choice == "1":
                            ...
                            find_and_show_detailed_information(student_manager)
                        elif choice == "6":
                            break
                        else:
